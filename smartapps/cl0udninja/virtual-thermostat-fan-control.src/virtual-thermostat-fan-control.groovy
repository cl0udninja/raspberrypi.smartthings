...
definition(
    ...
    author: "SmartThings",
    description: "Control a fan in conjunction with any temperature sensor, like a SmartSense Multi.",
...
preferences {
	...
	section("Select the heater or air conditioner outlet(s)... "){
		input "outlets", "capability.switchLevel", title: "Fan", required: true
        input "level", "number", range: "(1..99)", title: "Speed", required: true
	}
